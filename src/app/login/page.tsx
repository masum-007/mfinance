  ...
  return (
    <div className="min-h-screen flex bg-[#F9FAFB] p-4 sm:p-6 lg:p-8">
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-900 rounded-[3rem] p-12 flex-col justify-between relative overflow-hidden shadow-2xl">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-500/20 rounded-full blur-[120px] pointer-events-none translate-x-20 -translate-y-20" />
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg text-slate-400 font-medium max-w-md">
            Securely access your accounts, track your net worth, and manage your budgets in one unified ecosystem.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-12">
        <div className="w-full max-w-md space-y-10">
          ...
          <form action={login} className="space-y-6">
            ...
            <button type="submit" className="h-14 w-full rounded-2xl bg-primary text-white font-black flex items-center justify-center gap-2 shadow-xl shadow-primary/20 hover:-translate-y-0.5 hover:shadow-2xl transition-all cursor-pointer">
          ...
          <p className="text-center text-sm font-bold text-slate-500">
            ...
            <Link href="/signup" className="text-primary hover:underline decoration-2 underline-offset-4">
              Create one now
            </Link>
          </p>
        </div>
