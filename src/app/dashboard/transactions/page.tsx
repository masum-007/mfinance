...
const rawTypeFilter = searchParams?.type

const typeFilter: TransactionType | undefined =
  rawTypeFilter === TransactionType.INCOME ||
  rawTypeFilter === TransactionType.EXPENSE
    ? rawTypeFilter
    : undefined
  ...
  const [accounts, transactions, categories] =
    await Promise.all([
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 font-medium">
            Detailed history of your money flow.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-5">
                  <div
                    className={`h-14 w-14 shrink-0 flex items-center justify-center rounded-2xl transition-transform group-hover:scale-105 ${
                      isIncome
                ...
                <div
                  className={`text-xl font-black tracking-tighter shrink-0 ml-4 ${
                    isIncome
                      ? "text-emerald-600"
                      : "text-slate-900"
                  }`}
