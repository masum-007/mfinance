      ...
      {accounts.length === 0 ? (
        <div className="flex h-[350px] shrink-0 items-center justify-center rounded-[2.5rem] border-2 border-dashed bg-slate-50/50 border-slate-200">
          <div className="mx-auto flex max-w-[420px] flex-col items-center justify-center text-center p-6">
            ...
            <p className="text-slate-500 font-medium mb-6 mt-2">
              Add your first bank account or digital wallet to start
          ...
          {accounts.map((account) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl ${styles.gradient} to-transparent rounded-full blur-3xl opacity-40 group-hover:opacity-70 transition-opacity duration-500 pointer-events-none translate-x-10 -translate-y-10`}
                />
                ...
                <CardContent className="p-8 relative z-10 flex flex-col h-full justify-between min-h-[240px]">
                  <div className="flex justify-between items-start">
                    ...
                    <div
                      className={`h-14 w-14 rounded-2xl flex items-center justify-center ${styles.bg} ${styles.color} shadow-inner ring-1 ring-white/50 backdrop-blur-sm group-hover:scale-110 transition-transform duration-500`}
                    >
